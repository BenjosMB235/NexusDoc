...
// Modèle unifié pour les requêtes d'inscription
public class AuthRegistrationRequest {
    ...
    public AuthRegistrationRequest(String username, String email, String password,
                                   String phone, String fonction, Uri profileImageUri) {
